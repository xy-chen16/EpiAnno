...
## Tutorial  
### demo   
We also provide a [quick-start notebook](https://github.com/xy-chen16/EpiAnno/blob/master/code/demo.ipynb) which describes the fundamentals in detail and reproduces the results of EpiAnno.
### self-projection   
